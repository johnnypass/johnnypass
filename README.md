...
- [**Automated Chart Summaries with Lida + OpenAI**](https://github.com/johnnypass/Parsons_Data_Viz)
  A project that uses Microsoft's Lida and OpenAI to generate plain-language summaries of data visualizations. It explores how AI can make charts easier to understand and support   accessible data storytelling.
